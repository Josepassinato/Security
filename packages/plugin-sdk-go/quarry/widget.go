// Widget plugin support for the Quarry Go SDK.
//
...
//
// Widgets typically read from the Quarry API or directly from analytical
...
type Widget interface {
	...
	// Compute runs the widget computation against Quarry data and returns a
