...
func (m *mockEnricher) Manifest() quarry.PluginManifest {
...
func (m *mockAction) Manifest() quarry.PluginManifest {
	return quarry.PluginManifest{
		ID:         "test.mock-action",
		Name:       "Mock Action",
		Version:    "1.0.0",
...
func TestEnricherInvoke(t *testing.T) {
	...
	pctx := quarry.PluginContext{APIBaseURL: "http://localhost:8000", APIToken: "tok"}
	req := quarry.EnrichmentRequest{
