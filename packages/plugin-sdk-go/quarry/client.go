// Package quarry — async HTTP client for the Quarry REST API.
//
...
// ClientError is returned when the Quarry API responds with a non-2xx status.
...
func (e *ClientError) Error() string {
	return fmt.Sprintf("Quarry API error %d: %s", e.StatusCode, e.Body)
}
