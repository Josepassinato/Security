...
from .plugin import QuarryPlugin, PluginContext
...
class PluginRegistry:
    """Central registry for all loaded Quarry plugins."""

    def __init__(self) -> None:
        self._plugins: dict[str, QuarryPlugin] = {}

    # ── Registration ─────────────────────────────────────────────────────────

    def register(self, plugin: QuarryPlugin) -> None:
    ...
    def get(self, plugin_id: str) -> QuarryPlugin | None:
    ...
    def all(self) -> list[QuarryPlugin]:
