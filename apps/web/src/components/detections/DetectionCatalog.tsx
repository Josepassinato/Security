...
const MOCK_RULES: DetectionRule[] = [
  ...
  { id: 'sigma-3', name: 'LSASS Memory Dump via Procdump', description: 'Detects attempts to dump LSASS process memory using Sysinternals Procdump utility for credential extraction.', author: 'Quarry Community', logsource_category: 'process_creation', logsource_product: 'windows', level: 'critical', tags: ['attack.credential_access', 'attack.t1003.001'], install_count: 4102, rating: 4.9, rating_count: 201, status: 'published', submitted_at: '2026-01-10T08:00:00Z' },
      ...
      {!loading && !error && fetched && rules.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 text-zinc-500">
          ...
          <p className="text-xs mt-1">
            Publish rules with{' '}
            <code className="text-zinc-400">quarry detection validate &amp;&amp; quarry detection publish</code>
          </p>
        </div>
      )}
