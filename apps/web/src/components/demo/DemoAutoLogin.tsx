 ...
 *
 * it logs in as the well-known demo user (`demo@quarry.dev` / `quarry-demo` —
...
const DEMO_EMAIL =
  process.env.NEXT_PUBLIC_DEMO_AUTOLOGIN_EMAIL?.trim() || 'demo@quarry.dev';
const DEMO_PASSWORD =
  process.env.NEXT_PUBLIC_DEMO_AUTOLOGIN_PASSWORD?.trim() || 'quarry-demo';
