// Package quarryapi provides a lightweight HTTP client for the Quarry API
...
// Client talks to the Quarry API on behalf of the extension.
type Client struct {
	cfg    *config.Config
	http   *http.Client
}
...
// PersistenceEntry is one item from the Quarry persistence baseline for this
