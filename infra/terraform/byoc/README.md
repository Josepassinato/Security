# Quarry Bring-Your-Own-Cloud (BYOC)

This module provisions a production-ready Quarry control plane in your own AWS account.
...
1. Deploy the Quarry Helm chart into the EKS cluster using the outputs above.
...
For full multi-region or air-gapped variants, contact the Quarry maintainers.
